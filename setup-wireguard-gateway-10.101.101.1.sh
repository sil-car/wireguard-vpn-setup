...
# Peers
peers=(
    "# Nate-XPS|AO2i+0Dn61wOeOB0TcsgVbuH7nv4sdVe8OXiKa50Oy8=|10.101.101.2/32, ${IP6_108}2/128"
    "# Nate-Galaxy-A13|ELEKPlmiabwd+u9o8x9rh9KGDVlTzfxzB5HFWmBTOBg=|10.101.101.31/32, ${IP6_108}31/128"
)
for p in "${peers[@]}"; do
